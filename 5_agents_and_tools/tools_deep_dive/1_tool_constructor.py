...
"""
Example about how to build tools
we can build tool using:
    Tool: class to build tools from function
    StructuredTool: class to build more complex tool from function
"""
